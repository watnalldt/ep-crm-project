...
class Objection(TimeStampedModel):
    ...
    registration_date = models.DateField(
        verbose_name="Registration Date", null=True, blank=True
    )
    objection_date = models.DateField(
        verbose_name="Objection Date", null=True, blank=True
    )
    deadline_date = models.CharField(
        verbose_name="Deadline Date", max_length=25, null=True, blank=True
    )
    potential_start_date = models.DateField(
        verbose_name="Objection Date", null=True, blank=True
    )
    eac = models.IntegerField(verbose_name="EAC", null=True, blank=True)
    is_directors_approval = models.BooleanField(
        verbose_name="Directors Approval", default=False
    )
